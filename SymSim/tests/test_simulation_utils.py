...
from SymSim.utils.simulation_utils import _get_wavelength, _get_speckle_size, _get_deviation, _shape_function
from SymSim.utils.simulation_utils import _get_disorder, _get_speckle_intensity
...
class TestSimulationUtils(TestCase):
    ...
    def test_shape_function(self):
        ...
        plt.plot(np.degrees(a1),i1, label="1 nm sim")
        plt.plot(np.degrees(a2), i2, label="2 nm sim")
        plt.plot(np.degrees(a4), i4, label="4 nm sim")
        plt.legend()
